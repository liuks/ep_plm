...
class FinetuningConfig(object):
    ...
    def update(self, kwargs):
        for k, v in kwargs.items():
            ...
            self.__dict__[k] = v
        print (self.eval_batch_size, self.predict_batch_size)
        assert self.eval_batch_size == self.predict_batch_size, \
            'should be same, remaining=True in the evaluate and predict mode but padding input using eval_batch'
